...
All the "dumb" components, pipes, and directives should be implemented within a _Shared Module_. None of these types will import or inject services from _Core Modules_ or other _Feature Modules_. All data passed to these types should be sent through attributes in the template of the component that uses them.
