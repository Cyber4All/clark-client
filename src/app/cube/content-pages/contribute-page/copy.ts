                ...
                questions: [
                    {
                        ...
                        answer:
                            "Your profile shows your basic public user information on CLARK. This information includes your " +
                    ...
                    },
                    {
                        ...
                        answer:
                            "Your dashboard is where you will access and create all of your learning objects. The dashboard is the " +
                            ...
                            " draft learning objects include Draft, Waiting, and Review statuses and " +
                            " released includes all learning objects publicly available.",
                    },
                    {
                        question: "The Learning Object Builder",
                        answer:
                            'When clicking the <em>"NEW +"</em> button, it will direct you to the learning object builder to start ' +
        ...
        topics: [
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        answer:
                            "The basic information tab covers the required descriptive tags of a learning object. These tags include" +
                    ...
                    },
                    {
                        question: "Children",
                        answer:
                            "If a learning object is part of a set of multiple learning objects, an author could place it into a " +
            ...
            },
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        answer:
                            "After verifying the requirements checkbox, the author will be prompted to select a collection to submit" +
