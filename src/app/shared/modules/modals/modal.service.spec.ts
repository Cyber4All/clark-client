...
describe("ModalService", () => {
    ...
    it("should create dialog menu", inject(
        [ModalService],
    ...
    it("should close context menu", inject(
        [ModalService],
        (service: ModalService) => {
    ...
    it("should close dialog menu", inject(
        [ModalService],
        (service: ModalService) => {
    ...
    it("should close context and  dialog menu", inject(
        [ModalService],
        (service: ModalService) => {
            service.closeAll();
            expect(service.dialogMenuContent).toEqual({});
