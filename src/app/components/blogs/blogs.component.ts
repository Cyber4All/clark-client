...
export class BlogsComponent implements OnInit {
    ...
    dismissText =
        "You will not see this pop up again until the next blog post.";
    dismissOnceText =
        "You will not see this pop up again until you reload the page.";

    checkbox = false;
    view = 0;
    @Output() showBlogsBanner: EventEmitter<boolean> = new EventEmitter();
    @Output() neverShowBanner: EventEmitter<{
        val: boolean;
        recentBlog?: Blog;
    }> = new EventEmitter();
    ...
    ngOnInit(): void {
        ...
        this.utilityService.getAllBlogs().subscribe((blogArray: Blog[]) => {
