    ...
    ngOnInit(): void {
        ...
        if (this.errorCode) {
            ...
            if (this.errorCode === "401") {
                ...
                this.pMessage =
                    "The code sent to your email has expired, please request another email and try again.";
            } else {
                this.h1Message = "Unable to Verify Email";
                this.pMessage =
                    "We were unable to verify your email at this time. Please check back later.";
            }
        } else {
            this.authService.validateToken().then(async () => {
