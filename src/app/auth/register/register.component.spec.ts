...
describe("RegisterComponent", () => {
    ...
    beforeEach(() => {
        ...
        auth = {
            ...
            usernameInUse: jest
                .fn()
                .mockResolvedValue({ identifierInUse: false }),
    ...
    it("should move from info to organization when custom organization flow is enabled", () => {
        ...
        expect(component.currentTemp).toBe(
            component.TEMPLATES.organization.temp,
        );
        expect(component.currentIndex).toBe(
            component.TEMPLATES.organization.index,
        );
    });
    ...
    it("should require country on the custom organization form", () => {
        ...
        expect(
            component.organizationFormGroup
                .get("country")!
                .hasError("required"),
        ).toBe(true);
        expect(component.organizationFormGroup.get("country")!.touched).toBe(
            true,
        );
    });
    ...
    it("should require state only when country is US", () => {
        ...
        expect(component.organizationFormGroup.get("state")!.enabled).toBe(
            true,
        );
        expect(
            component.organizationFormGroup.get("state")!.hasError("required"),
        ).toBe(true);
        ...
        expect(component.organizationFormGroup.get("state")!.disabled).toBe(
            true,
        );
