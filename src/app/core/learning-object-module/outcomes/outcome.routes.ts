...
export const OUTCOME_ROUTES = {
  ...
  /**
   * Gets the outcome stats for all learning objects
   * @returns LearningOutcomeStats object containing the apply_and_analyze, evaluate_and_synthesize, and remember_and_understand
   */
  GET_LEARNING_OUTCOME_STATS() {
    return `${environment.apiURL}/learning-outcomes/stats`;
  },
};
