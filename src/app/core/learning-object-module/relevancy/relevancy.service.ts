...
export class RelevancyService {
    ...
    async setNextCheckDate(learningObjectId: string, date: Date): Promise<any> {
        return this.http
            .patch(
                RELEVANCY_ROUTES.UPDATE_RELEVANCY_CHECK_DATE(learningObjectId),
                { date },
                {
    ...
    async assignEvaluators(args: {
        ...
        return this.http
            .post(RELEVANCY_ROUTES.ADD_EVALUATOR(), args, {
                headers: this.headers,
                withCredentials: true,
                responseType: "text",
            })
    ...
    async removeEvaluators(args: {
        ...
        return this.http
            .patch(RELEVANCY_ROUTES.UPDATE_EVALUATORS(), args, {
                headers: this.headers,
                withCredentials: true,
                responseType: "text",
            })
     ...
     */
    async updateLearningOutcomeMappings(
        objectId: string,
        outcomeId: string,
        guidelineIds: string[],
    ): Promise<void> {
        return await new Promise((resolve, reject) => {
            this.http
                .patch(
                    RELEVANCY_ROUTES.UPDATE_MAPPING(objectId, outcomeId),
