...
export class BlogsComponentService {
    ...
    constructor(private utilityService: UtilityService) {
        this.utilityService.getAllBlogs().subscribe((blogArray) => {
    ...
    getShowBanner(): boolean {
        ...
        if (Date.now() - recentBlogDateTime.valueOf() > 604800000) {
            // if the most recent blog is older than 1 week, do not display a banner
            return false;
        }
