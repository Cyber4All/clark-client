...
export class ListComponent {
    ...
    @Output() cancelCollectionSubmission: EventEmitter<LearningObject> =
        new EventEmitter();
    @Output() openChangelog: EventEmitter<any> = new EventEmitter();
    @Output() submitToCollection: EventEmitter<LearningObject> =
        new EventEmitter();
    @Output() submitHierarchy: EventEmitter<LearningObject> =
        new EventEmitter();
