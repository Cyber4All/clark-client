...
import { NgClass, NgStyle, AsyncPipe, SlicePipe, TitleCasePipe, DatePipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [TipDirective, NgClass, NgStyle, AsyncPipe, SlicePipe, TitleCasePipe, DatePipe, CollectionPipe]
})
