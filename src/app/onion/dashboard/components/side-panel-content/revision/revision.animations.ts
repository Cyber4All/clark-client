...
const backToFront = [
  style({ backgroundColor: 'white', position: 'absolute', transform: 'translateY(0px) scale(0.9)', boxShadow: '0 2px 20px 1px rgba(0, 0, 0, 0)', left: 0, right: 0, zIndex: 1 }),
  animate('500ms 50ms ease', keyframes([
    style({ transform: 'translateY(50px) scale(0.95)', zIndex: 2, offset: 0.5 }),
    style({ transform: 'translateY(0px) scale(1)', boxShadow: '0 2px 20px 1px rgba(0, 0, 0, 0.04)', zIndex: 2, offset: 1 })
  ])),
];
...
const frontToBack = [
  ...
  animate('550ms ease', keyframes([
    ...
    style({ transform: 'translateY(0px) scale(0.9)', boxShadow: '0 2px 12px 1px rgba(0, 0, 0, 0)', zIndex: 1, offset: 1 })
  ])),
];
