...
devenv_root = "/Users/luis/Code/development-environment/clark-client";
devenv_dotfile = "/Users/luis/Code/development-environment/clark-client/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/var/folders/cp/8c_mzskd7x56tw5djtrghfrc0000gn/T/";
devenv_runtime = "/var/folders/cp/8c_mzskd7x56tw5djtrghfrc0000gn/T/devenv-63eb12f";
devenv_istesting = false;
devenv_direnvrc_latest_version = 1;
container_name = null;
active_profiles = [ ];
hostname = "SecurEd-MacBook.local";
username = "luis";
git_root = "/Users/luis/Code/development-environment/clark-client";
